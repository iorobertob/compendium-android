package com.ideasBlock.compendium.GUI
...
import com.ideasBlock.compendium.R
...
class RoundedCorner : FrameLayout {
    ...
    private fun init(context: Context, attrs: AttributeSet?, defStyle: Int) {
        ...
        context.theme.obtainStyledAttributes(
            attrs,
            R.styleable.RoundedCorner,
            0, 0).apply {

            try {
                CORNER_RADIUS = getFloat(R.styleable.RoundedCorner_radius, 3.0f)
            } finally {
                recycle()
            }
        }
    ...
    companion object {
        private var CORNER_RADIUS = 1.0f
    }
}